...
<div class="modal-body">
              <div class="form-group mt20 top">
                ...
                <div class="col-sm-8">
                  <input type="text" tabindex="1"  placeholder="Nama user" id="name"  class="form-control" name="name" value="{{ isset($user)? $user->name : '' }}">
                </div>
              </div>
              <div class="form-group mt20">
                ...
                <div class="col-sm-8">
                  <input type="text" tabindex="5" placeholder="Masukkan Username" id="username" class="form-control" name="username"  value="{{ isset($user)? $user->username : '' }}">
                </div>
              </div>
              @if(isset($user))
                  <div class="form-group mt20">
              ...
              <div class="col-sm-4">
                <select tabindex="3"  name="id_status" id="id_status" class="form-control search-select select2-offscreen status">
                    <?php
                        foreach($status as $s){
                            echo  '<option value="'.($s->id).'" '.(  (isset($user->id) && ($s->id) == $user->id)? 'selected' : '').'>'.$s->status.'</option>';
                        }
                    ?>
                </select>
              </div>
