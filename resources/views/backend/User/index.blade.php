      ...
      <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
              ...
              <ol class="breadcrumb">
                  <li><i class="clip-home-3"></i><a href="{{ url('/dashboard') }}"> Home</a></li>
...
$(document).ready(function() {
  user = $('#asset_table').dataTable({
              ...
              "aoColumns": [
                  ...
                  { "mData": "name",  "nama": "name", "sWidth": "15%", "sClass": "", "bSortable": true, "bSearchable": true},
                  { "mData": "username", "name": "username", "sWidth": "15%", "sClass": "text-center", "bSortable": false, "bSearchable": false},
                  { "mData": "id_status", "name": "id_status", "sWidth": "8%", "sClass": "text-center", "bSortable": false, "bSearchable": false},
                  { "mData": "updated_at",  "nama": "updated_at", "sWidth": "10%", "sClass": "", "bSortable": true, "bSearchable": true},
              ...
              "aoColumnDefs": [
                {
                  ...
                  "mRender": function( data, type, row) {
                      switch (row.id_status) {
                          case 1: return '<span class="label label-inverse">Admin</span>'; break;
                          case 2: return '<span class="label label-warning">User</span>'; break;
                      }
                  }
                }
              ],
