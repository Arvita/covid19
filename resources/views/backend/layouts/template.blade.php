...
<html lang="en" class="no-js">
	...
	<head>
		...
		<link rel="stylesheet" href="{{asset('public/backend/plugins/bootstrap-spinedit/css/bootstrap-spinedit.css')}}" />
 		<link rel="stylesheet" href="{{ asset('public/backend/plugins/datepicker/css/datepicker.css') }}">
		<!--[if IE 7]>
		...
		<link rel="stylesheet" href="{{ asset('public/backend/plugins/DataTables/media/css/DT_bootstrap.css') }}" />
		<link rel="stylesheet" href="{{ asset('public/backend/plugins/bootstrap-modal/css/bootstrap-modal-bs3patch.css') }}"/>
		<link rel="stylesheet" href="{{ asset('public/backend/plugins/bootstrap-modal/css/bootstrap-modal.css') }}" />
		<link href="{{ asset('public/backend/plugins/select2/select2.css') }}" rel="stylesheet" />
	...
	<body>
        ...
        <!-- Logo -->
        		<img id="default-logo" src="{{ asset('public/backend/images/logo.svg')}}" width="300px" alt="Starhotel" >
        		</a>
			</div>
					...
					<ul class="nav navbar-right">
						...
						<li class="dropdown current-user">
							<a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
								<img src="{{ asset('public/backend/images/avatar-1-small.jpg')}}" class="circle-img" alt="">
		...
		<![endif]-->
		<!--[if gte IE 9]><!-->
		<script src="{{ asset('public/backend/plugins/jQuery-lib/2.0.3/jquery.js')}}"></script>
		<!--<![endif]-->
		...
		<script src="{{ asset('public/backend/plugins/moment/min/moment.min.js')}}"></script>
		<script src="{{ asset('public/backend/plugins/knockout/knockout.js')}}"></script>
		<script src="{{ asset('public/backend/plugins/DataTables/media/js/jquery.dataTables.min.js') }}"></script>
		<script src="{{ asset('public/backend/plugins/DataTables/media/js/DT_bootstrap.js') }}"></script>
		<script src="{{ asset('public/backend/plugins/DataTables/plugins/fnReloadAjax.js') }}"></script>
		<script src="{{ asset('public/backend/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js')}}"></script>
		<script src="{{asset('public/backend/plugins/bootstrap-spinedit/js/bootstrap-spinedit.js')}}"></script>

		<script src="{{ asset('public/backend/plugins/jquery-validation/dist/jquery.validate.min.js')}}"></script>
		<script src="{{ asset('public/backend/plugins/jquery-validation/dist/additional-methods.js') }}"></script>
		<script src="{{ asset('public/backend/plugins/jquery-validation/lib/jquery.form.js') }}"></script>

		<script src="{{ asset('public/backend/plugins/select2/select2.min.js')}}"></script>

		<script src="{{ asset('public/backend/plugins/bootstrap-modal/js/bootstrap-modal.js') }}"></script>
		<script src="{{ asset('public/backend/plugins/bootstrap-modal/js/bootstrap-modalmanager.js') }}"></script>
		<script src="{{ asset('public/backend/js/modal.js') }}"></script>
		<script src="{{ asset('public/backend/plugins/blockUI/jquery.blockUI.js')}}"></script>
		<script src="{{ asset('public/backend/js/block.js') }}"></script>
		...
		<script src="{{ asset('public/backend/plugins/flot/jquery.flot.pie.js')}}"></script>
		...
		<script src="{{ asset('public/backend/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.js')}}"></script>
		<script src="{{ asset('public/backend/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js')}}"></script>
		<script src="{{ asset('public/backend/plugins/fullcalendar/fullcalendar/fullcalendar.js')}}"></script>
